...
export const BlockedModerateConfidence: Story = {
  args: {
    ...
    decisionTime: '19 Feb 2026, 09:41:02 UTC',
    syncState: 'pending',
...
export const MonitoringConflictingEvidence: Story = {
  args: {
    ...
    monitoringNote: '19 Feb 2026, 12:08:57 UTC',
    syncState: undefined,
    syncNote: undefined,
...
export const MonitoringInsufficientEvidence: Story = {
  args: {
    ...
    decisionTime: undefined,
    monitoringNote: '19 Feb 2026, 11:56:40 UTC',
    syncState: undefined,
    syncNote: undefined,
...
export const ManuallyAllowed: Story = {
  args: {
    ...
    explanation: 'Ada O. allowed this visitor on 18 Feb 2026 as internal QA traffic. The original decision and its evidence remain on record.',
    decisionTime: '17 Feb 2026, 16:20:05 UTC',
    syncState: undefined,
    syncNote: undefined,
